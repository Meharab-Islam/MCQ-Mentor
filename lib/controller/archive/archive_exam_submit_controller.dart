...
class ArchiveExamSubmitController extends GetxController {
  final int examId;
  final int durationMinutes;

  ArchiveExamSubmitController({required this.examId, required this.durationMinutes});
  ...
  /// Select an answer
  Future<void> submitExam(int archive_id) async {
    ...
    try {
      ...
      final postData = {
        "archive_id":archive_id.toString() ,
